package com.tssa301.bds04.controllers;
...
import com.tssa301.bds04.dto.EventDTO;
import com.tssa301.bds04.tests.TokenUtil;
...
public class EventControllerIT {
	...
	public void insertShouldReturn422WhenAdminLoggedAndPastDate() throws Exception {
		...
		result.andExpect(jsonPath("$.errors[0].message").value("The event date cannot be passed"));
	}
